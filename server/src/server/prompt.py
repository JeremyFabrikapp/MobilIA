...
# L'utilisateur actuel a les handicap suivants :
# - Cognitifs : déficience intellectuelle
# - Visuel : vue quasi nulle

# Commence la conversation en demandant à l'utilisateur où il veut aller. Garde tes réponses concises et ne rentre pas dans les détails. Si tu as plusieurs choix, demande à l'utilisateur de préciser.
# """
